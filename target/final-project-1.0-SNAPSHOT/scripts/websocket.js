const wsUri = "wss://" + document.location.host + document.location.pathname + "endpoint";
...
websocket.close = function (event){
    displayError("Connection lost. Please try again later.")
}
...
websocket.onerror = function (event){
    displayError("ERROR: " + event.data + ". Open the browser's developer console to see the full error.")
}
